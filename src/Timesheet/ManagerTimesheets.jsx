...
const ManagerTimesheets = () => {
  ...
  const fetchSubmissions = useCallback(async () => {
    ...
    try {
      let url = `https://localhost:3000/api/timesheets/list/manager/${employeeId}`;
        
      if (startDate && endDate) {
        url = `https://localhost:3000/api/timesheets/totalList/employeeId/${employeeId}/startDate/${startDate}/endDate/${endDate}`;
      }
  ...
  const handleApprove = async (id) => {
    ...
    try {
      await axios.put(`https://localhost:3000/api/timesheets/Approve/${id}/status/APPROVED`, null, {
        headers: {
  ...
  const handleReject = async () => {
    setLoading(true);
    try {
      await axios.put(`https://localhost:3000/api/timesheets/reject/${currentId}/status/REJECTED/comments/${comments}`, null, {
        headers: {
