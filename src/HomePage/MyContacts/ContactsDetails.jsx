...
const ContactsDetails = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://teamwebapp123.azurewebsites.net/apis/employees/contacts/contacts/${contactId}`,{
                    headers: {
    ...
    const deleteContact = async () => {
        await axios.delete(`https://teamwebapp123.azurewebsites.net/apis/employees/contacts/contacts/${contactId}`,{
            headers: {
              "Authorization": `Bearer ${token}`  // Add the token to the Authorization header
            }
          });
        ...
        return (
            <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                    <button
                        onClick={() => navigate('/Contacts')} // This will navigate back to the previous page
