...
const LeaveSheet = () => {
 ...
 const fetchLeaveSheet =  async () => {
  try{
    ...
    const response = await axios.get("https://teamwebapp123.azurewebsites.net/api/getSheets", {
        method:'GET',
        headers:{
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if(isSubmitted && leaveId){
        const response =  await axios.put(`https://teamwebapp123.azurewebsites.net/api/updateSheet/${leaveId}`, leaveData, {
        ...
        setIsSubmitted(true); // Ensure it remains submitted
          ...
          const response = await axios.post(
            "https://teamwebapp123.azurewebsites.net/api/submitSheet",
            leaveData, {
...
<h2 className="text-2xl font-bold text-center text-blue-600 mb-8">Leave Sheet Form</h2>
